    ...
    public class LocalProceduralBiome : MonoBehaviour, IProceduralBiome, ISerializationCallbackReceiver
    {
        ...
        private IEnumerator RequestDataProgressive(BiomeDataRequest request, Bounds worldBounds, int heightMapResolution, int textureResolution)
        {
            ...
            if (cachedData == null)
            {
                ...
                CoroutineUtility.StartCoroutine(TerrainGraphUtilities.RequestBiomeData(cacheDataRequest, graphToExecute, biomeWorldBoundsInt, space, m_baseResolution, m_seed, inputContainer, m_dataMask, inputProvider.FillTerrainGraphArguments));
        ...
        public void RecalculateFalloffAnchors()
        {
            ...
            {
                m_falloffAnchors = AnchorUtilities.GetFalloff(m_anchors, m_falloffDistance);
            }
        }
        ...
        {
            Bounds worldBounds;
            if (m_falloffAnchors == null || m_falloffAnchors.Length == 0)
            {
            ...
            else
            {
                ...
                foreach (Vector3 a in m_falloffAnchors)
                {
