...
public class FlyingDemon : DemonFramework
{
    ...
    [SerializeField] float maxFlightHeight, minFlightHeight;
    ...
    public override void OnUpdate()
    {
        ...
        if(Physics.SphereCast(transform.position,wallCheckRadius,Vector3.up,out RaycastHit hit,maxFlightHeight,wallLayer)) 
        {
            targetYheight = (hit.point-transform.position).y;
        }
        
        targetYheight = Mathf.Clamp(targetYheight,minFlightHeight,maxFlightHeight);
