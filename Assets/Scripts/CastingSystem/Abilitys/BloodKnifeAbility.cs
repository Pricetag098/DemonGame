...
public class BloodKnifeAbility : Ability
{
    ...
    protected virtual void Launch()
    {
        ...
        projectileSpawner.Spawn().GetComponent<DamageProjectiles>().Shoot(lastOrigin, mid,end,maxRange/speed, damage * caster.DamageMulti, this, Mathf.RoundToInt(chargePenetrationCurve.Evaluate(chargePercent)),0) ;
